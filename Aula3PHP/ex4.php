...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['num1'], $_GET['num2'], $_GET['num3'], $_GET['operacao'])) {
    $num1 = $_GET['num1'];
    $num2 = $_GET['num2'];
    $num3 = isset($_GET['num3']) ? $_GET['num3'] : null;
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $pg_atual == 'divisao' ? 'active' : '' ?>" href="?pg=divisao">Divisão</a>
                </li>
                <li class="nav-item">
...
<div class="container-fluid">
    ...
    <?php elseif ($pg_atual == 'resultado' && $resultado !== null): ?>
        <h1>Resultado:</h1>
        <p><strong>Resultado da <?= $operacao == 'soma' ? 'soma' : ($operacao == 'subtracao' ? 'subtração' : ($operacao == 'multiplicacao' ? 'multiplicação' : 'divisão')) ?>:</strong> <?= $resultado ?></p>
    <?php endif; ?>
</div>
